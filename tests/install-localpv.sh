...
mkdir -p /tmp/openebs
kubectl apply -f https://openebs.github.io/charts/versioned/3.8.0/hostpath-operator.yaml
wget https://openebs.github.io/charts/versioned/3.8.0/openebs-lite-sc.yaml -O /tmp/openebs-lite-sc.yaml
